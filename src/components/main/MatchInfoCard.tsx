...
export default function MatchInfoCard({ match }: MatchInfoCardProps) {
  ...
  return (
    <div
      className={`group relative overflow-hidden rounded-[32px] border backdrop-blur-xl transition-all duration-500 hover:-translate-y-1 hover:shadow-2xl ${themeClass}`}
    >
      <div
